...
# TODO: Import werkzeug security functions for password hashing
...
class User(db.Model):
    ...
    )  # TODO: Use password_hash instead
    ...
    # TODO: Implement set_password() method to hash passwords
    # Hint: Use generate_password_hash() from werkzeug.security

    # TODO: Implement check_password() method to verify passwords
    # Hint: Use check_password_hash() from werkzeug.security
